...
function Carousel({
  ...
  // O Embla é um store externo: `canScrollPrev/Next` são derivados dele, não
  // estado próprio do React. Ler via `useSyncExternalStore` mantém o valor
  // sincronizado sem setState dentro de efeito.
